...
// APB adapter
wire [31:0] wdata = apbs_wdata;
reg [31:0] rdata;
wire wen = apbs_sel && apbs_enable && apbs_write;
wire ren = apbs_sel && apbs_enable && !apbs_write;
wire [15:0] addr = apbs_addr & 16'h1c;
assign apbs_rdata = rdata;
assign apbs_ready = 1'b1;
assign apbs_slverr = 1'b0;
